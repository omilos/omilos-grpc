...
class LoginRequest$Type extends MessageType<LoginRequest> {
    ...
    create(value?: PartialMessage<LoginRequest>): LoginRequest {
        const message = { timestamp: 0n, signature: new Uint8Array(0) };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
...
class Cast$Type extends MessageType<Cast> {
    constructor() {
        super("omilos_grpc.Cast", [
            ...
            { no: 7, name: "replies", kind: "scalar", T: 4 /*ScalarType.UINT64*/, L: 0 /*LongType.BIGINT*/ },
            { no: 8, name: "reactions", kind: "scalar", T: 4 /*ScalarType.UINT64*/, L: 0 /*LongType.BIGINT*/ },
            { no: 9, name: "recasts", kind: "scalar", T: 4 /*ScalarType.UINT64*/, L: 0 /*LongType.BIGINT*/ },
            { no: 10, name: "watches", kind: "scalar", T: 4 /*ScalarType.UINT64*/, L: 0 /*LongType.BIGINT*/ },
    ...
    create(value?: PartialMessage<Cast>): Cast {
        const message = { hash: "", threadHash: "", parentHash: "", text: "", replies: 0n, reactions: 0n, recasts: 0n, watches: 0n, recast: false };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* uint64 replies */ 7:
                    message.replies = reader.uint64().toBigInt();
                    break;
                case /* uint64 reactions */ 8:
                    message.reactions = reader.uint64().toBigInt();
                    break;
                case /* uint64 recasts */ 9:
                    message.recasts = reader.uint64().toBigInt();
                    break;
                case /* uint64 watches */ 10:
                    message.watches = reader.uint64().toBigInt();
                    break;
                case /* bool recast */ 11:
...
class Author$Type extends MessageType<Author> {
    constructor() {
        super("omilos_grpc.Author", [
            { no: 1, name: "fid", kind: "scalar", T: 4 /*ScalarType.UINT64*/, L: 0 /*LongType.BIGINT*/ },
            { no: 2, name: "username", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 3, name: "display_name", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 4, name: "profile_picture", kind: "message", T: () => ProfilePicture },
            { no: 5, name: "follower_count", kind: "scalar", T: 4 /*ScalarType.UINT64*/, L: 0 /*LongType.BIGINT*/ },
            { no: 6, name: "following_count", kind: "scalar", T: 4 /*ScalarType.UINT64*/, L: 0 /*LongType.BIGINT*/ }
        ]);
    }
    create(value?: PartialMessage<Author>): Author {
        const message = { fid: 0n, username: "", displayName: "", followerCount: 0n, followingCount: 0n };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: Author): Author {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* uint64 fid */ 1:
                    message.fid = reader.uint64().toBigInt();
                    break;
                case /* string username */ 2:
                    message.username = reader.string();
                    break;
                ...
                case /* uint64 follower_count */ 5:
                    message.followerCount = reader.uint64().toBigInt();
                    break;
