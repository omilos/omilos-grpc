...
class Cast$Type extends MessageType<Cast> {
    constructor() {
        super("omilos_grpc.Cast", [
            ...
            { no: 7, name: "replies", kind: "scalar", T: 4 /*ScalarType.UINT64*/ },
            { no: 8, name: "reactions", kind: "scalar", T: 4 /*ScalarType.UINT64*/ },
            { no: 9, name: "recasts", kind: "scalar", T: 4 /*ScalarType.UINT64*/ },
            { no: 10, name: "watches", kind: "scalar", T: 4 /*ScalarType.UINT64*/ },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* uint64 reactions */ 8:
                    message.reactions = reader.uint64().toString();
                    break;
                case /* uint64 recasts */ 9:
                    message.recasts = reader.uint64().toString();
                    break;
                case /* uint64 watches */ 10:
                    message.watches = reader.uint64().toString();
                    break;
                case /* bool recast */ 11:
...
class Author$Type extends MessageType<Author> {
    constructor() {
        super("omilos_grpc.Author", [
            ...
            { no: 3, name: "display_name", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 4, name: "profile_picture", kind: "message", T: () => ProfilePicture },
            { no: 5, name: "follower_count", kind: "scalar", T: 4 /*ScalarType.UINT64*/ },
            { no: 6, name: "following_count", kind: "scalar", T: 4 /*ScalarType.UINT64*/ }
        ]);
    }
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: Author): Author {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* uint64 fid */ 1:
                    message.fid = reader.uint64().toString();
                    break;
                case /* string username */ 2:
                    message.username = reader.string();
                    break;
                ...
                case /* uint64 follower_count */ 5:
                    message.followerCount = reader.uint64().toString();
                    break;
